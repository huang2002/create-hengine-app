...
If you find some bug or want some new feature, you may [open an issue](https://github.com/huang2002/create-hengine-app/issues/new) on GitHub.
...
2. View [the existing issues](https://github.com/huang2002/create-hengine-app/issues) and check whether there has already been an issue reporting such a bug or discussing about such a feature request. If it has already been such one, please do not open another one. (That is, do not make duplicated issues.)
